    ...
    for i  in range (dd.r_rows):
        ...
        for j in range (dd.r_cols):
             ...
             if ind < dimension:
                  ...
                  d.rect( traval3 ,x=m3list[ind][0]-d.Blen*0.38 , y=m3list[ind][1]- d.Bwid*0.25,length= d.Blen , width=d.Bwid, cradius= 10 , data =round(element , 2 )  , stroke=3,fill_color="yes" , color="#FF9A00")
                  traval1.clear()
                  traval2.clear()
